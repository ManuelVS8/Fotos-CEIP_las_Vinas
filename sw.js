// sw.js — Service worker de la web de recuerdos (Las Viñas)
// Solo cachea el "esqueleto" de la app (HTML, manifest, iconos), NO las fotos/vídeos,
// para no llenar el almacenamiento del móvil con cientos de MB automáticamente.

const CACHE_NAME = 'las-vinas-shell-v1';
const APP_SHELL = [
  './index.html',
  './site.webmanifest',
  './icono192.png',
